...
public class MensagemSophia3 : MonoBehaviour {

    public GameObject chloe;
    public GameObject chamaDoug;
    ...
    void Update()
    {
        ...
        if (MensagemNathan2.sophiaFinal == true)
        {
            Habilitar();
        }
    ...
    void Desabilitar()
    {
        ...
        estaAtivo = false;
        MensagemNathan2.sophiaFinal = false;
        MensagemChloe3.chloeFinal = true;
    }
}
